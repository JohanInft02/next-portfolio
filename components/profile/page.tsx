...
export default function ProfileSection() {
  ...
  const primaryTechnologies = ["React", "Next.js", "Node.js", "TypeScript", "Docker", "Kubernetes", "AWS", "GraphQL"]
    ...
    <Card className="bg-[#b7c7c9a1] dark:bg-[#252b48] p-4 md:p-6 flex flex-col items-center justify-center relative overflow-hidden card theme-transition hover:bg-[#c9cbcba1] dark:hover:bg-[#2a3152]">
      ...
      <div className="relative flex flex-col items-center text-center">
        <Image
          ...
          priority
        />
        <h2 className="text-xl font-bold text-black dark:text-white mb-1 theme-transition">Johan Infante</h2>
        <p className="text-blue-800 dark:text-blue-300 text-sm mb-4 theme-transition">Lic. Desarrollo Software</p>
        <p className="text-xs text-black italic dark:text-gray-300 text-center mb-6 max-w-[250px] theme-transition">
          El que no se anima a trabajar, empobrece: el que trabaja duro, se enriquece. Proverbios 10:4 PDT
        </p>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-start gap-4">
                ...
                <p className="col-span-3">
                  Desarrollador apasionado por crear soluciones innovadoras. Especializado en tecnologías web y DevOps,
                  siempre buscando aprender y aplicar las últimas tendencias en el mundo del desarrollo de software.
                </p>
              </div>
              <div className="grid grid-cols-4 items-start gap-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <span className="col-span-3">Diseño de interfaces de usuario (UI/UX)</span>
              </div>
            </div>
          </DialogContent>
        </Dialog>
