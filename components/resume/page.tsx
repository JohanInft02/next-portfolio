  ...
  return (
    <Card className="h-full bg-[#b7c7c9a1] dark:bg-[#252b48] p-6 hover:bg-[#c9cbcba1] dark:hover:bg-[#2a3152] transition-colors card theme-transition">
      <div className="flex flex-col h-full justify-between">
        <div>
          <h3 className="text-xl font-bold text-black dark:text-white mb-2 theme-transition">Curriculum Vitae</h3>
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center text-sm text-black dark:text-gray-400 theme-transition" suppressHydrationWarning>
